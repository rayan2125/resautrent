...
import {  merchantImg, removemImg } from '../../redux/Reducers/perInfoReducers';

const MerchantImages = () => {
    let dispatch = useDispatch()
    let selector = useSelector(state => state.prnInfo.mImage)
    ...
    const handleCamera = () => {
        const options = {
            ...
            if (response.didCancel) {
                ...
                dispatch(merchantImg(response.assets?.[0]))
            }
        });
    }
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={{paddingVertical: 10,  }}>
                ...
                <View style={{  }}>
                    <Text style={{ color: "black", fontSize: 25, fontWeight: "400" }}>Upload Hotel Photo</Text>
                            ...
                            <View style={{ alignItems: "center", paddingHorizontal: selector === null ? 20 : 0, paddingVertical: selector === null ? 20 : 10 }}>
                                {
                                    selector === null ?
                                        <View style={{ alignItems: "center" }}>
                                            ...
                                            <Text style={{ fontSize: 20, fontWeight: '400' }}>Please Upload Your Hotel Photos </Text>
                                            <TouchableOpacity
