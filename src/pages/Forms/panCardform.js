...
import { adharCard, panCard, removepan } from '../../redux/Reducers/perInfoReducers';

const PanCardForm = () => {
    let dispatch = useDispatch()
    let selector = useSelector(state => state.prnInfo.panInfo)
    ...
    const handleCamera = () => {
        const options = {
            ...
            if (response.didCancel) {
                ...
                dispatch(panCard(response.assets?.[0]))
            }
        });
    }
    ...
    return (
        <View style={{ flex: 1 }}>
            <View style={{  paddingVertical: 10,  }}>
                ...
                <View style={{  }}>
                    <Text style={{ color: "black", fontSize: 25, fontWeight: "400" }}>Pan card details</Text>
                            ...
                            <View style={{ alignItems: "center", paddingHorizontal: selector === null ? 20 : 0, paddingVertical: selector === null ? 20 : 10 }}>
                                {
                                    selector === null ?
                                        <View style={{ alignItems: "center" }}>
                                            ...
                                            <Text style={{ fontSize: 20, fontWeight: '400' }}>Front side photo of your Pan card with your clear name and photo</Text>
                                            <TouchableOpacity
